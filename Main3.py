 				...
 				for i in results_in_list:
 					a=i.split(':')
  					if (a[0]=='Original code' or a[0]=='Translated code'):
   						...
   						uri=a[1]+':'+a[2]
   						links.append(uri)
		return render_template("results.html", no=number_of_results, no2=number_of_translations, trans=translation, DownloadXML=DownloadUrl, Links_and_Matches=zip(links,results_in_list), scroll='results')			
